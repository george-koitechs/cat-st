...
import { useAutosizeTextArea } from "@/components/__ui-kit/textarea/use-autosize-textarea";
import { useCombinedRefs } from "@/components/__ui-kit/textarea/use-combined-refs";
...
export const Textarea = forwardRef<HTMLTextAreaElement, TextAreaProps>(
  ({ label, value = "", onChange, className, wrapperClassName, errorMessage, ...props }, ref) => {
    ...
    return (
      <div className={classNames("textarea", wrapperClassName)}>
        ...
        <label
          htmlFor={props.name}
          className={classNames("textarea__label", { textarea__label_error: !!errorMessage })}
        >
          {label}
        </label>
      </div>
