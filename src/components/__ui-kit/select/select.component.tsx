    ...
    <div className="select">
      <div className="select__select" onClick={open}>
        <span className="select__value">
          {withFlag && <img src={options.find((o) => o[optionKey] === value)?.flag} alt="" style={{ width: 16 }} />}
          {value}
        </span>
      ...
      {!!label && (
        <p
          ...
          className={classNames("select__label", { select__label_focused: isOpened || !!value })}
        >
          {label}
        </p>
      )}
      {isOpened && (
        <>
          ...
          <div className="select__options">
            {options.map((c) => (
              <div
                className={classNames("select__option", { select__option_selected: value === c[optionKey] })}
